...
export const auctionItemsPage: AuctionItemsPage = {
  ...
  seo: {
    ...
    description:
      "Browse dozens of charity auction items: celebrity signed guitars, sports memorabilia, travel, jewelry and meet & greets. Risk-free consignment for nonprofits.",
    targetTerms: [
